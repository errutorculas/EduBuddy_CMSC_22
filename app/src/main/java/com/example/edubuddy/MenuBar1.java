 ...
 * Subjects panel in order to execute the necessary widgets
 * used in the code derived from android package.
 *
 * @version 1.0
 * @since 2020-12-15
 */
public class MenuBar1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //lambda expression for the back button going back to the subjects
        ...
        //lambda expression for the logout button going to the main activity (home)
        ...
        //lambda expression for the back button going to the message panel
