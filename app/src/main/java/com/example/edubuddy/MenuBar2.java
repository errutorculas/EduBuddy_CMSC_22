 ...
 * Messages panel in order to execute the necessary widgets
...
public class MenuBar2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //lambda expression for the back button going back to the messages
        ...
        //lambda expression for the back button going to the main activity (home)
